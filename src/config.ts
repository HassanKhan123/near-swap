export function getExtendConfig(env: string = "mainnet") {
  switch (env) {
    case "production":
    case "mainnet":
      return {
        RPC_LIST: {
          defaultRpc: {
            url: "https://rpc.ankr.com/near/f064a0dd6d0f195e4a1f62d9d9dae9f45f93bdcf85fa8cb854c5df64b8ecafa1",
...
export default function getConfig(env: string = "mainnet") {
...
export function getExtraStablePoolConfig(env: string = "mainnet") {
  switch (env) {
    case "production":
    case "mainnet":
      return {
